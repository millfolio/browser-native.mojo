...
#
# First build pulls chromiumoxide (a Chrome is needed at RUNTIME, not build time:
# rec_start attaches to its CDP endpoint). The pure logic has cargo unit tests
# (`cargo test`); the live capture path needs a running Chrome to exercise.
set -e
